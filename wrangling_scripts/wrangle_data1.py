...
df0 = pd.read_csv('./data/API_SP.RUR.TOTL_DS2_en_csv_v2_9914824.csv', skiprows=4)
# df = pd.read_csv('./data/API_SP.RUR.TOTL_DS2_en_csv_v2_9914824.csv')
keepcolumns=['Country Name', '1990', '2015']
df0 = df0[keepcolumns]
top10country = ['United States', 'China', 'Japan', 'Germany', 'United Kingdom', 'India', 'France', 'Brazil',
                    'Italy', 'Canada']
df0 = df0[df0['Country Name'].isin(top10country)]

value_variables=['1990', '2015']

df_melt = df0.melt(id_vars='Country Name', value_vars=value_variables)
